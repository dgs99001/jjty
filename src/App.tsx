  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100">
      ...
      <button
        ...
        className="fixed bottom-4 right-4 sm:bottom-6 sm:right-6 z-50 flex items-center justify-center gap-2 px-3 py-3 sm:px-4 sm:py-3 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105 active:scale-95 touch-manipulation"
        style={{ backgroundColor: '#03a84e' }}
        aria-label="在线客服"
      >
        <MessageCircle className="w-5 h-5 sm:w-6 sm:h-6 text-white flex-shrink-0" />
        <span className="text-white font-semibold text-sm whitespace-nowrap hidden sm:inline">在线客服</span>
      </button>
    </div>
  );
}
